...
textContentClassElements[2].querySelector("h4").textContent =
  siteContent["main-content"]["services-h4"];
textContentClassElements[2].querySelector("p").textContent =
  siteContent["main-content"]["services-content"];
textContentClassElements[3].querySelector("h4").textContent =
  siteContent["main-content"]["product-h4"];
textContentClassElements[3].querySelector("p").textContent =
  siteContent["main-content"]["product-content"];
textContentClassElements[4].querySelector("h4").textContent =
  siteContent["main-content"]["vision-h4"];
textContentClassElements[4].querySelector("p").textContent =
...
let myNav = document.querySelectorAll('nav')[0].appendChild(document.createElement('a'));
myNav.textContent = "appended element";

let prepender = document.querySelector(".top-content .text-content p");
